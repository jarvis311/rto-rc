...
const ResponseSuccessProtected = async function(msg){
    return({
        status:true,
        response_code:200,
...
export default {cathError,ResponseErrorDataMsg, ResponseError, ResponseErrorMsg, ResponseSuccessMsg, ResponseSuccess , ResponseSuccessProtected }
